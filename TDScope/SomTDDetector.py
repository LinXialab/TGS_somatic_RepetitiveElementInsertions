...
importlib.reload(DataScanner)
importlib.reload(DecisionMaker)
...
def TDscope(TDRecord, DataMaker, DecisionMaker):
    '''
    ...
    Record = DecisionMaker(TDRecord, sequenceList, ReadIDs, flank_5, flank_3)
...
def main(args):
    ...
    results = []
    for TDRecord in TDRecordList[1:]:
        result = P.apply_async(TDscope, (TDRecord,DataMaker_exe,Decision_exe,))
